# custom slider ---------
slowSliderInput <- function(inputId, label, min, max, value, step = NULL,
                        round = FALSE,
                        ...
                        timezone = NULL, dragRange = TRUE)
{
  ...
  sliderProps <- dropNulls(list(
    class = "slowSliderInput js-range-slider",
    id = inputId,
...
slowNumericInput <- function(inputId, label, value, min = NA, max = NA, step = NA,
                         width = NULL) {
  
  # build input tag
  inputTag <- tags$input(id = inputId, type = "slownumber", class="form-control",
